...
namespace CalidadT2.Repositories
{
    public interface ILibroRepository
    {
        ...
        Libro DetailLibro(int id);
        void Comentar(Comentario comentario, int userid);
    ...
    public class LibroRepository : ILibroRepository
    {
        ...
        public void Comentar(Comentario comentario,int userid)
        {
        ...
        public Libro DetailLibro(int id)
        {
